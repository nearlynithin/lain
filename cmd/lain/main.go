...
func run() error {
	...
	fs.StringVar(&sqlAddr, "sql-addr", "postgresql://nithin:lv72hmUypcxGMNwNNldV6Q@groovy-mule-8115.8nk.cockroachlabs.cloud:26257/defaultdb?sslmode=verify-full", "SQL address")
